...
void Choix_direction(UCHAR sens)
{
  ...
  P2OUT = P2OUT + (((sens<<1U)+(sens<<4U))& 0x22U);  /*algorithme pour définit le sens de robot*/
}
...
*------------------------------------------------------------------------------
*/
void Vitesse_moteurs(UINT_32 vit_gauche, UINT_32 vit_droite)
{
  TA1CCR1 = (SINT_32)vit_gauche;                      /* rapport cyclique moteur 1*/
  TA1CCR2 = (SINT_32)vit_droite;                      /* rapport cyclique moteur 2*/
}
